          ...
          <div className="row">
            <div className="col-12 col-md-10 col-lg-6 ">
              <div className="hero-head-txt">
                KYC on Blockchain Network
                <br />
                Done More{' '}
                <span className="quick-effect">Quickly & Securely</span>
              </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <h6>
                        Once you have clicked on ‘Start your KYC’ or ‘Connect to
                        Wallet’, just read and follow the following simple steps
                        and click on ‘Proceed’ button to complete your KYC and
                        migrate to Era Swap Network (ESN).
                      </h6>
                      <ul className="comlistui">
                        <li>
                          {' '}
                          Once you click on ‘Proceed’ button at the bottom of
                          this Pop-Up Message, a Tab of https://eraswap.life/
                          opens on your screen to Load your Wallet
                        </li>
                        <li>
                          {' '}
                          Load your Wallet through https://eraswap.life/{' '}
                        </li>
                        <li>
                          {' '}
                          Click on Your Wallet Address on the Top Right of your
                          screen and then click on ‘Apply KYC’
                        </li>
                        <li>
                          {' '}
                          Now you are on KYC Level 1. Fill up your required KYC
                          Details and upload documents. Then click on 'Submit'.
                          After that click on 'Next' to go to Level 2
                        </li>
                        <li>
                          {' '}
                          In KYC Level 2, select specific Era Swap Ecosystem
                          Platform by clicking on the platform logo, you need to
                          do Level 2 KYC. Fill up platform specific details
                          required and click on ‘Submit’. Then click on ‘Next’
                          to go to Level 3
                        </li>
                        <li>
                          {' '}
                          You can also skip Level 2 for now by clicking on
                          ‘Next’ Button but please remember that you have to
                          complete Level 2 KYC to be eligible to use Era Swap
                          Platforms as Verified User.
                        </li>
                        <li>
                          {' '}
                          In KYC Level 3, Click on ‘Sign this Message' to finish
                          your KYC process
                        </li>
                        <li>
                          {' '}
                          You will get a Pop-up message for your confirmation
                          ‘Are you sure to sign message?’
                        </li>
                        <li> Click on ‘Yes, Sign it!’</li>
                        <li>
                          {' '}
                          A successful submission Pop-Up message will appear
