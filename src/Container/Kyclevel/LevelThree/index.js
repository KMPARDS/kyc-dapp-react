                ...
                <h6>
                  ...
                  <button
                    ...
                    onClick={(event) => {
                      ...
                      this.setState({
                        message:
                          'I hereby declare and authorize info@eraswapfoundation.com to upgrade all my TimeAlly staking from 1 year to 2 years to participate in Era Swap Network Proof of Stake Consensus Protocol (ESNPoSCP). I have read and understood the TimeAlly terms and conditions.\n\nFull Name:\nContact Number:',
                      });
                    }}
                  >
                ...
                <div className="yourwallet">
                  ...
                  {/* <div class="form-group mt20">
                    <label for="formGroupExampleInput">
                      I hereby declare and authorize info@eraswapfoundation.com
                      to upgrade all my TimeAlly staking from 1 year to 2 years
                      to participate in Era Swap Network Proof of Stake
                      Consensus Protocol (ESNPoSCP). I have read and understood
                      the TimeAlly terms and conditions.
                    </label>
                  </div>
                  <Row>
                    <Col sm={6}>
                  ...
                  <button
                    ...
                    onClick={async (event) => {
                      ...
                      try {
                        ...
                        alert(
                          'There was a error signing. Can you try loading your wallet again?'
                        );
                      }
                    }}
                  >
                  ...
                  {this.state.signature ? (
                    <>
                      <h6 className="mt10">
                        Your signature: (click below to copy)
                      </h6>
