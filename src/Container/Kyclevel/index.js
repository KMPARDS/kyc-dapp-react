                                ...
                                <Col sm={6} >
                                    <form>
                                        <div class="form-group">
                                            <label htmlFor="currentAdd">Current Address</label>
                                ...
                                <Col sm={6} >
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <Field id="permAdd" name="permAdd" rows="4" cols="100" placeholder="Enter your Permanent Address" className={'form-control textHt' + (errors.permAdd && touched.permAdd ? ' is-invalid' : '')} />
                                            <ErrorMessage name="permAdd" component="div" className="invalid-feedback" />
                                        </div>
                                    </form>
                                </Col>
                            </Row>
