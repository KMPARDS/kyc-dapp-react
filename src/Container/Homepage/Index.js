    ...
    return (
      <div>
        ...
        <div className="future-container" id="solution">
          <h2 className="future-head">
            The future of Identity
            <br /> <span className="red-color-txt">Verification</span> is here
          </h2>
          <p className="para-txt-future">
            To stay complaint with regulators and to stop sophisticated
            financial crimes, KYC DApp is being created{' '}
          </p>
              ...
              <Row>
                <Col lg={4} md={6} sm={8} className="mx-auto">
                  ...
                  <div>
                    ...
                    <hr
                      className="bg-color--primary border--none mx-auto  jsElement dash-red"
                      data-height="3"
                      data-width="80"
                    />
                    <p className="text-center">
                      {' '}
                      KYC DApp, complaint documents are stored on blockchain
                ...
                <Col lg={4} md={6} sm={8} className="mx-auto">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-center">
                      Via KYC DApp, a customer could update their personal
                      information across all the platforms of Era Swap Ecosystem
                    </p>
                  </div>
                </Col>
                ...
                <Col lg={4} md={6} sm={8} className="mx-auto">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-center">
                      This One Stop KYC for multiple platforms of ESE will save
                      repetitive and reiterative work.{' '}
                    </p>
                  </div>
                </Col>
              </Row>
